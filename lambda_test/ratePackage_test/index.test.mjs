...
describe('Rate Package Handler', () => {
    ...
    test('should handle gzipped content package successfully', async () => {
        // Create a mock package.json and gzip it
        const packageJson = {
            name: "cloudinary",
            version: "2.5.1",
            homepage: "https://github.com/cloudinary/cloudinary_npm",
        ...
        // Create a mock readable stream from the gzipped buffer
        const mockStream = new Readable();
        mockStream.push(gzippedBuffer);
        mockStream.push(null);
    ...
    test('should handle invalid URL in gzipped content', async () => {
        // Create package.json with invalid URL and gzip it
        const packageJson = {
            name: "test-package",
            repository: {
                url: "https://invalid-url.com/repo"
