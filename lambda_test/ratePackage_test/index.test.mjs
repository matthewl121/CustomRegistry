...
describe('Rate Package Handler', () => {
    ...
    const summary = `
    Summary of Tests:
    - 'should handle NPM package successfully' → statusCode: 200
    - 'should handle GitHub package successfully' → statusCode: 200
    - 'should handle zip file content package successfully' → statusCode: 200
    - 'should handle invalid URL in zip content' → statusCode: 200
    - 'should return 404 for non-existent package' → statusCode: 404
    - 'should handle missing package ID' → statusCode: 400
    `;
