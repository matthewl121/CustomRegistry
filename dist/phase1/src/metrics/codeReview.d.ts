 ...
 */
export declare function calcCodeReview(owner: string, repo: string, token: string): Promise<number>;
/**
 ...
 */
export declare const calcCodeReviewScore: (linesIntroduced: number, totalLines: number) => number;
