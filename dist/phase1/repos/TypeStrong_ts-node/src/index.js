...
exports.createEsmHooks = exports.TSError = exports.DEFAULTS = exports.VERSION = exports.debug = exports.INSPECT_CUSTOM = exports.env = exports.REGISTER_INSTANCE = exports.createRepl = void 0;
 ...
 */
exports.DEFAULTS = {
    cwd: exports.env.TS_NODE_CWD ?? exports.env.TS_NODE_DIR,
    ...
    experimentalReplAwait: (0, util_1.yn)(exports.env.TS_NODE_EXPERIMENTAL_REPL_AWAIT) ?? undefined,
...
function createFromPreloadedConfig(foundConfigResult) {
    ...
    if (!transpileOnly) {
        ...
        if (!options.compilerHost) {
            ...
            const host = ts.createIncrementalCompilerHost(config.options, sys);
...
function registerExtension(ext, service, originalHandler) {
    ...
    require.extensions[ext] = function (m, filename) {
        ...
        (0, node_internal_modules_cjs_loader_1.assertScriptCanLoadAsCJS)(service, m, filename);
...
function filterDiagnostics(diagnostics, filters) {
    return diagnostics.filter((d) => filters.every((f) => (!f.appliesToAllFiles && f.filenamesAbsolute.indexOf(d.file?.fileName) === -1) ||
