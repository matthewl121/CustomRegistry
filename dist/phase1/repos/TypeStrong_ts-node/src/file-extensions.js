...
exports.tsSupportsMtsCtsExts = tsSupportsMtsCtsExts;
...
function tsSupportsMtsCtsExts(tsVersion) {
    return (0, util_1.versionGteLt)(tsVersion, '4.5.0');
}
/**
