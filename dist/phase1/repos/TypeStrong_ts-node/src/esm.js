...
function createEsmHooks(tsNodeService) {
    ...
    const runMainHackUrl = (0, url_1.pathToFileURL)((0, path_1.resolve)(__dirname, '../dist-raw/runmain-hack.js')).toString();
    /**
    ...
    async function load(url, context, defaultLoad) {
        return addShortCircuitFlag(async () => {
            ...
            const format = context.format ?? (await getFormat(url, context, nodeGetFormatImplementation.defaultGetFormat)).format;
