...
function createResolve(opts) {
    ...
    function emitFolderMapDeprecation(match, pjsonUrl, isExports, base) {
        ...
        process.emitWarning(`Use of deprecated folder mapping "${match}" in the ${isExports ?
    ...
    function resolvePackageTargetString(target, subpath, match, packageJSONUrl, base, pattern, internal, conditions) {
        ...
        if (pattern)
            return new URL(StringPrototypeReplace(resolved.href, patternRegEx, subpath));
...
//# sourceMappingURL=node-internal-modules-esm-resolve.js.map