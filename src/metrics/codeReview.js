...
exports.calcCodeReviewScore = exports.calcCodeReview = void 0;
...
function calcCodeReview(owner, repo, token) {
    return __awaiter(this, void 0, void 0, function () {
        var codeReview, codeReviewActivity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, githubApi_1.fetchCodeReviewActivity)(owner, repo, token)];
                case 1:
                    codeReviewActivity = _a.sent();
 ...
 */
var calcCodeReviewScore = function (linesIntroduced, totalLines) {
    // the bigger the fraction, the better
    var linesPulledFraction = linesIntroduced / totalLines;
    // Define a constant to control the curve's steepness
    var k = Math.log(2); // ≈ 0.69314718056
    // Calculate the score using an exponential growth formula
    var score = 1 - Math.exp(-k * linesPulledFraction);
