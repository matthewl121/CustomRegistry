...
exports.metricsCalculator = {
    calculateMetrics: function (owner, repo, token, repoURL, repoData, inputURL) {
        return __awaiter(this, void 0, void 0, function () {
            var busFactorWorker, correctnessWorker, rampUpWorker, responsivenessWorker, licenseWorker, dependencyPinningWorker, codeReviewWorker, results, _a, busFactor, busFactorLatency, _b, correctness, correctnessLatency, _c, rampUp, rampUpLatency, _d, responsiveness, responsivenessLatency, _e, license, licenseLatency, _f, dependencyPinning, dependencyPinningLatency, _g, codeReview, codeReviewLatency, scores, _h, netScore, netScoreLatency, metrics, error_1;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 1:
                        results = _j.sent();
                        _a = results[0], busFactor = _a.score, busFactorLatency = _a.latency, _b = results[1], correctness = _b.score, correctnessLatency = _b.latency, _c = results[2], rampUp = _c.score, rampUpLatency = _c.latency, _d = results[3], responsiveness = _d.score, responsivenessLatency = _d.latency, _e = results[4], license = _e.score, licenseLatency = _e.latency, _f = results[5], dependencyPinning = _f.score, dependencyPinningLatency = _f.latency, _g = results[6], codeReview = _g.score, codeReviewLatency = _g.latency;
                        scores = {
                            busFactor: busFactor,
                        ...
                        _h = (0, netScore_1.calculateNetScore)(scores), netScore = _h.score, netScoreLatency = _h.latency;
                        metrics = {
                            URL: inputURL,
                            NetScore: netScore,
