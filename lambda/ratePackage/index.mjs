    ...
    try {
       ...
       // Parse customRegistryResult and map it to the required fields
        ...
        const parsedResult = {
            ...
            LicenseScore: parseFloat(parsedCustomRegistryResult.License || 0),
            LicenseScoreLatency: parseFloat(parsedCustomRegistryResult.License_Latency || 0),
            GoodPinningPractice: parseFloat(parsedCustomRegistryResult.DependencyPinning || 0),
            GoodPinningPracticeLatency: parseFloat(parsedCustomRegistryResult.DependencyPinning_Latency || 0),
            PullRequest: parseFloat(parsedCustomRegistryResult.PullRequest || parsedCustomRegistryResult.CodeReview || 0),
            PullRequestLatency: parseFloat(parsedCustomRegistryResult.CodeReview_Latency || 0),
