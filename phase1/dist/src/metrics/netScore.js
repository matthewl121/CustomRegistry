...
function calculateNetScore(scores) {
    try {
        ...
        const netScore = (scores.busFactor * exports.METRIC_WEIGHTS.BUS_FACTOR) +
        ...
        (0, log_1.logToFile)(`Error in calculateNetScore: ${error instanceof Error ? error.message : String(error)}`, 1);
        return {
            score: -1,
            latency: 0
        };
