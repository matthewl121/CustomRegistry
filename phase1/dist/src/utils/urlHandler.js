...
function getRepoDetails(token, inputURL) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hostname = (0, exports.extractDomainFromUrl)(inputURL);
                    if (!hostname || (hostname !== "www.npmjs.com" && hostname !== "github.com")) {
                        process.exit(1);
                    }
                    repoURL = "";
                    if (!(hostname === "www.npmjs.com")) return [3 /*break*/, 2];
                    npmPackageName = (0, exports.extractNpmPackageName)(inputURL);
                    if (!npmPackageName) {
                        process.exit(1);
                    }
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    repoDetails = (0, exports.extractGithubOwnerAndRepo)(repoURL);
                    if (!repoDetails) {
                        process.exit(1);
                    }
