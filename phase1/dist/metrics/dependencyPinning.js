 ...
 * - Tilde ranges (~1.2.0)
 */
export const isVersionPinned = (version) => {
    try {
 ...
 */
export async function calcDependencyPinningScore(packageJson) {
    try {
        const dependencies = {
        ...
        const pinnedDeps = Object.entries(dependencies)
            .filter(([_, version]) => isVersionPinned(version))
            .length;
 ...
 */
export async function calcDependencyPinning(owner, repo, token) {
    try {
