...
*/
import { fetchCodeReviewActivity, fetchContributorActivity, fetchRepoData, checkFolderExists } from "../src/api/githubApi";
...
describe('Test suite', () => {
    ...
    test('apiPostRequest', async () => {
        ...
        const response = await apiPostRequest(url, body, token);
        expect(response).not.toBe(null);
    });
