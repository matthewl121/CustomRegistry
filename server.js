...
import { downloadPackageHandler, ratePackageHandler, updatePackageHandler, uploadPackageHandler, getPackageByRegexHandler, getPackagesHandler, getTracksHandler, resetRegistryHandler, packageCostHandler >
...
if (req.body.Content) {
    dackageData.Content = req.body.Content;
